...
class Marble_LeNet_ELU(BaseNet):
...
class  Marble_LeNet_ELU_Autoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        # Decoder
        self.deconv1 = nn.ConvTranspose2d(int(self.rep_dim / (16 * 16)), 128, 5, bias=False, padding=2)
